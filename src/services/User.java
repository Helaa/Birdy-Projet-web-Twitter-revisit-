...
public class User {
	public static JSONObject createUser(String login, String nom, String prenom, String pwd, String mail) throws SQLException {
		...
		return ErrorJSON.serviceAccepted("User " + login  +" inserted succesufully.");
	}
	...
	public static JSONObject deleteUser(String login) throws SQLException {
		...
		return ErrorJSON.serviceAccepted("User " + login  +" deleted succesufully.");
	...
	public static JSONObject getUser(String login) throws JSONException, SQLException {
		...
		obj.put("infoProfile: ", UserTools.getUser(id));
		return obj;
	}
